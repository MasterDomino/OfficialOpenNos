...
namespace OpenNos.GameObject
{
    public class Act4Stat
    {
        ...
        public int MinutesUntilReset { get { return (int)(_nextMonth - DateTime.Now).TotalMinutes; } }

        public byte Mode { get; set; }

        public int Percentage { get { return (Mode == 0 ? _percentage : 0); } set { _percentage = value; } }

        public short CurrentTime { get { return (Mode == 0 ? (short)0 : (short)(_latestUpdate.AddSeconds(_totalTime) - DateTime.Now).TotalSeconds); } }

        public short TotalTime
        {
            get
            {
                return (Mode == 0 ? (short)0 : _totalTime);
            }
            set
            {
                _latestUpdate = DateTime.Now;
