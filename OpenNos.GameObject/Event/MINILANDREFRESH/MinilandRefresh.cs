...
namespace OpenNos.GameObject.Event
{
    public static class MinilandRefresh
    {
        ...
        public static void GenerateMinilandEvent()
        {
            ...
            {
                GeneralLogDTO gen = DAOFactory.GeneralLogDAO.LoadByAccount(null).LastOrDefault(s => s.LogType == GeneralLogType.MinilandRefresh && s.Timestamp.Day == DateTime.Now.Day);
            ...
            DAOFactory.GeneralLogDAO.Insert(new GeneralLogDTO { LogType = GeneralLogType.MinilandRefresh, LogData = "World", Timestamp = DateTime.Now });
